...
Эллиптические кривые могут быть заданы, например, в форме Монтгомери ($By^2=x^3+Ax^2+x$) или Эдвардса ($ax^2+y^2=1+dx^2y^2$).
...
\begin{thebibliography}{1}\addcontentsline{}{section}{Список литературы}
